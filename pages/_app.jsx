...
function MyApp({ Component, pageProps, user }) {
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="google-site-verification" content="gptiH-d68AHHUPj5Y_GIr5GinsuQz6hpltFg2yU_HQg" />
        <script
          id="ss"
  ...
  `,
      ...
      >
        ...
        <div className={`feedback-wrap ${feedbackOpen ? "open" : "hide"}`}>
          <div
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              dispatch(sendFeedback({ score, review }));
              ...
              <div className="feedback-rate">
                <div className="feedback">
                  <div className="rating">
                    <input
                      type="radio"
                      onChange={(e) => setScore(e.target.checked ? 5 : null)}
                      name="rating"
                      id="rating-5"
                    />
