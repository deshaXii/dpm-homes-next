        ...
        <div className="counterdown-content">
          <span className="time-col days">
            ...
            <span className="subject">
              <span></span><FormattedMessage id="components.countdown.days" />
            </span>
          </span>
          <span className="time-col">
            <span className="counting counting-hours">--</span>
            <span className="subject">
              <span></span><FormattedMessage id="components.countdown.hours" />
            </span>
          </span>
          <span className="time-col">
            <span className="counting counting-minutes">--</span>
            <span className="subject">
              <span></span><FormattedMessage id="components.countdown.minutes" />
            </span>
          </span>
          <span className="time-col">
            <span className="counting counting-seconds">--</span>
            <span className="subject">
              <span></span><FormattedMessage id="components.countdown.seconds" />
            </span>
          </span>
        </div>
      </div>
