...
import { addAdministrativeBoth } from "../../store/slices/properties";
...
const AdministrativeBoth = () => {
  ...
  const handelAddProperty = (e) => {
    e.preventDefault();
    setShowLoading(true);
    dispatch(addAdministrativeBoth(data)).then((res) => {
...
export default AdministrativeBoth;
