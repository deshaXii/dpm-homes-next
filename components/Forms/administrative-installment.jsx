...
import { addAdministrativeInstallment } from "../../store/slices/properties";
...
const AdministrativeInstallment = () => {
  ...
  const handelAddProperty = (e) => {
    e.preventDefault();
    setShowLoading(true);
    dispatch(addAdministrativeInstallment(data)).then((res) => {
...
export default AdministrativeInstallment;
