...
import { addAdministrativeCash } from "../../store/slices/properties";
...
const AdministrativeCash = () => {
  ...
  const handelAddProperty = (e) => {
    e.preventDefault();
    setShowLoading(true);
    dispatch(addAdministrativeCash(data)).then((res) => {
...
export default AdministrativeCash;
